...
The goal is to classify clothing images into 10 categories and evaluate different model configurations through multiple experiments.
...
Model Performance	Good (≈84% Accuracy)
👨‍💻 Author
